    ...
    <body>
        ...
        <form action="LoginControl" 
            ...
            <div class="form-group">
                <input name="email" required="required" class="form-control" value="${cookie.username1.value}" />
                <label class="form-label">Email</label>
            </div>            
            <div class="form-group">
                <input name="password" id="password" type="password" required="required" class="form-control" value="${cookie.password1.value}"/>
